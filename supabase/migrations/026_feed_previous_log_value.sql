-- Feed: include previous numeric log for the same author + goal (trend arrows in app)
-- Must drop first: PostgreSQL cannot change OUT/return columns via CREATE OR REPLACE.
